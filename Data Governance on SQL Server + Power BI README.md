...
Step 4: Perform Column masking with PHI of Patient Name, Insurance ID, Patient DOB.
...
Step 1. Establish SQL Server Connection on Power BI and Login as Business Analyst User. Verify that the PHI data is masked.
...
Step 3: Establish connection with SQL Server as Data Analyst User. Verify that the PHI data is masked.
